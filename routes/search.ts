...
module.exports = function searchProducts () {
  return (req: Request, res: Response, next: NextFunction) => {
    ...
    // Je fais un replace assez strict pour avoir des recherches uniquement alpha numérique
    // Dans burp on a un success mais on a data[] vide
    // {"status":"success","data":[]}
    criteria = criteria.replace(/[^a-zA-Z0-9 ]/g, '')
